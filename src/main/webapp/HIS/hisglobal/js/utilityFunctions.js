...
function onclickShowHideImg(imgObj)
{
	...
	if(divObj.style.display=="none")
	{
		...
		imgObj.src = "/SSO/hisglobal/images/arrow-up.png";
	}
	else if(divObj.style.display=="block")
	{
		divObj.style.display="none";
		imgObj.src = "/SSO/hisglobal/images/arrow-down.png";
	}
}
...
function setAJAXLoading(elem)
{
	elem.innerHTML="<table id='tblLoading' width='100%' height='100%' cellpadding='0' cellspacing='0' border='0'>" + 
		"<tr><td width='100%' align='center'><img id='imgLoading' name='imgLoading' alt='Loading' title='Loading' src='/SSO/hisglobal/images/loading.gif'>" + 
		"</td></tr></table>";
}
