...
function adt_create_loading_msg(){
	...
	wt+='<div style="padding:20px;"><img src="/DWH_MSO/hisglobal/images/loading.gif" width=16 height=16><br><br><font size="2" weight="bold">Fetching Details.Please Wait!</font></div>';
	wt+='</div>';
